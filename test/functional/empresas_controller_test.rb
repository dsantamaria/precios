...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { direccion: @empresa.direccion, estado: @empresa.estado, nombre: @empresa.nombre, telefono: @empresa.telefono }
    end
  ...
  test "should update empresa" do
    put :update, id: @empresa, empresa: { direccion: @empresa.direccion, estado: @empresa.estado, nombre: @empresa.nombre, telefono: @empresa.telefono }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
