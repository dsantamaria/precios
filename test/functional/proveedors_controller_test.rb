...
class ProveedorsControllerTest < ActionController::TestCase
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post :create, proveedor: { direccion: @proveedor.direccion, estado: @proveedor.estado, nombre: @proveedor.nombre, telefono: @proveedor.telefono }
    end
  ...
  test "should update proveedor" do
    put :update, id: @proveedor, proveedor: { direccion: @proveedor.direccion, estado: @proveedor.estado, nombre: @proveedor.nombre, telefono: @proveedor.telefono }
    assert_redirected_to proveedor_path(assigns(:proveedor))
  end
